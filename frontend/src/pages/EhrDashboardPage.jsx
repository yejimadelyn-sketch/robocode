    ...
    <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '2rem' }}>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '2rem', flexWrap: 'wrap', gap: '1rem' }}>
        <div>
          ...
          <p style={{ color: 'var(--text-primary)', background: 'rgba(16, 185, 129, 0.1)', borderLeft: '4px solid #10b981', padding: '1rem', borderRadius: '0.5rem', marginTop: '1rem', maxWidth: '800px', lineHeight: '1.5' }}>
            <strong>What is an EHR?</strong> An Electronic Health Record (EHR) is a digital version of a patient's medical history. This interactive dashboard simulates how hospitals and researchers securely store and analyze patient Diagnoses, Medications, and Lab Tests. Try using the Search Bar or toggling the views!
          </p>
        </div>
