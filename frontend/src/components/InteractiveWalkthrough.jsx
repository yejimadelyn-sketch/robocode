...
const stages = [
  ...
  },
  {
    ...
    description: "For advanced researchers, the viewer launches the PheTK Wizard. This visual tool runs massive Phenome-Wide Association Studies and generates professional Manhattan plots without writing any code.",
